...
#############################################################################################################
 public function bmgroupAction()
    {
        $this->addTitleTab('bmgroup', $this->translate('Groups'), $this->translate('List host groups'));
        $this->setAutorefreshInterval(12);
...
#############################################################################################################
#############################################################################################################
 public function cspgroupAction()
    {
        $this->addTitleTab('cspgroup', $this->translate('Groups'), $this->translate('List host groups'));
        $this->setAutorefreshInterval(12);
